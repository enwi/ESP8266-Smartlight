...
#ifndef __SK6812_I2S_DEFS_H__
#define __SK6812_I2S_DEFS_H__
...
#define NUM_RGBW_BYTES      (num_leds * 4)
#define NUM_I2S_PIXEL_BYTES (num_leds * 4 * 4)  // (#leds) * (RGBW) * (4 i2s bits)
#define NUM_I2S_PIXEL_WORDS (num_leds * 4)
...
#define WS_I2S_DIV          (4)
#define NUM_I2S_ZERO_BYTES  (28)                       // SK6812 LED Treset = 67us (must be >50us)

...
#if SK6812_USE_INTERRUPT == 1
// for debugging purposes
static volatile uint32_t interrupt_count = 0;

static void SK6812_isr(void)
{
...
void SK6812_dma(sdio_queue_t *i2s_pixels_queue)
{
  // Reset DMA
  ...
  ets_isr_attach(ETS_SLC_INUM, (int_handler_t)SK6812_isr , (void *)0);
